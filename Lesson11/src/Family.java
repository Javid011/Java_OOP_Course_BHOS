...
public class Family implements HumanCreator {
    ...
    private Pet pet;
    private static String[] maleNames = {"Tural", "Orkhan", "Elvin", "Ramil", "Samir", "Eldar", "Ruslan", "Kamran", "Vugar", "Ilkin"};
    private static String[] femaleNames = {"Aysel", "Nigar", "Lala", "Gunay", "Sabina", "Fidan", "Zeynab", "Nazrin", "Sevda", "Tamilla"};
    ...
    public Human bornChild() {
        ...
        int randomNameIndex=rand.nextInt(isMale?maleNames.length:femaleNames.length);
    ...
    public boolean equals(Object that) {
        ...
        return Objects.equals(mother, thatFamily.mother) && Objects.equals(father, thatFamily.father);
    }
    @Override
    public int hashCode() {
        int result=17;
