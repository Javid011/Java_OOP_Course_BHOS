...
public class Human {
    ...
    public void describePet() {
        ...
        System.out.println("I have a "+family.getPet().getSpecies()+". It is " + family.getPet().getAge()+" years old, he is "+isSly);
    }
    public boolean feedPet(boolean isFeedingTime) {
        ...
        if(!isFeedingTime)
        {
            ...
            if(family.getPet().getTrickLevel()>randNum)
            {
                isFeedingTime=true;
            }
        }
    ...
    public boolean equals(Object that) {
        ...
        return Objects.equals(name, thatHuman.name) && Objects.equals(surname, thatHuman.surname) && year==thatHuman.year && iq==thatHuman.iq;
    }
    @Override
    public int hashCode() {
        int result=17;
