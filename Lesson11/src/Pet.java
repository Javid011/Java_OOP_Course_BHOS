...
public abstract class Pet {
    ...
    public boolean equals(Object that) {
        ...
        return Objects.equals(getSpecies(), thatPet.getSpecies()) && Objects.equals(nickname, thatPet.nickname) && age==thatPet.age && trickLevel==thatPet.trickLevel;
    }
    @Override
    public int hashCode() {
        int result=17;
    ...
    public String toString() {
        ...
        return getSpecies() + "{nickname='" + nickname + "', age=" + age + ", trickLevel=" + trickLevel + ", habits=" + Arrays.toString(habits) + ", characteristics=" + canfly + ", has " + getSpecies().numberOfLegs + " legs, " + hasFur + "}";
    }
    @Override
